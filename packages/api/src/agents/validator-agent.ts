...
export async function triageFeedback(projectId: string, feedbackIds: string[], deps: OrchestratorDeps): Promise<ReadableStream<AgentStreamEvent>> {
...
export async function generateIssue(projectId: string, feedbackId: string, deps: OrchestratorDeps): Promise<ReadableStream<AgentStreamEvent>> {
